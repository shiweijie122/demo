...
public class DataTypeDemo {
	public static void main(String[] args) {
		...
		*/
		...
		float pi = 3.14F; //3.14F为float的直接量
		double a=6.0,b=4.9;
		...
		*/
		...
		System.out.println(5/2); //2，小数位无条件舍弃
		System.out.println(2/5); //0，小数位无条件舍弃
