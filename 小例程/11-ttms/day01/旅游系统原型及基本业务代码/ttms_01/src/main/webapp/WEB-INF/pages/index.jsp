...
%>
	...
	<link rel="stylesheet" href="<%=basePath %>/css/TreeGrid.css">	
	...
	<script type="text/javascript" src="<%=basePath%>/plugins/daterangepicker/moment.js"></script>
	...
	<script type="text/javascript" src="<%=basePath%>/js/TreeInit.js"></script>
	...
	<!-- 导入当前页面的css样式 -->
	<link href="<%=basePath%>/css/dash-board.css" rel="stylesheet" type="text/css"/>
</head>
...
<script>
    $(document).ready(function () {
        $('#content').empty().load(basePath+"/notice/dashBoardList.do");
    });
</script>
</html>