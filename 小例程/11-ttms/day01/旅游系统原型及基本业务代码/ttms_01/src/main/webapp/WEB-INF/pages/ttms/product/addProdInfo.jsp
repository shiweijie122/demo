...
<div class="container">
	...
	<form method="post" class="form-horizontal" id="newProduct" >
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					<label class="col-md-2 control-label">产品编号</label>
					<div class="col-md-4">
						<p class="form-control-static">保存后自动生成</p>
					</div>
					<label class="col-md-2 control-label"> <i class="mandatory">*</i>团号 </label>
					<div class="col-md-4">
						<select name="numId" id="numId" class="form-control required">
							<option value="">请选择产品团号</option>
							<option value="22">三亚春季七天五夜游</option>
							<option value="23">三亚春季三日游</option>
							<option value="24">三亚春季双人七日游</option>
							<option value="25">三亚春季五日游</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<label class="col-md-2 control-label">产品负责人
					</label>
					<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control datepicker dateISO compareDate required" name="srvcBeginDate" id="beginDate"  value="" size="10">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control datepicker dateISO compareDate required" name="srvcEndDate" id="endDate"  value="" size="10">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control datepicker dateISO compareDate2 required" id="beginDate2"  name="onlineDate" size="10">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control datepicker required dateISO compareDate2 " id="endDate2" name="offlineDate"  value="" size="10">
											</div>
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="startDate" id="beginDate3"  class="form-control datepicker   required dateISO compareDate3" size="10">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="endDate" id="endDate3"  class="form-control datepicker required dateISO compareDate3" size="10">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<select name="nights" id="trip_night" class="form-control required"  style="width: 80px">
...
<c:url var="url" value="/js/product/addProdInfo.js"></c:url>
