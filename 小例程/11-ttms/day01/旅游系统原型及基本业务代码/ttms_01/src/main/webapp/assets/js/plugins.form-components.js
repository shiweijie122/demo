var FormComponents = function () {
    ...
    var e = function () {
        if ($.fn.tagsInput) {
            $(".tags").tagsInput({width: "100%", height: "auto", defaultText: "add a tag"})
        }
    };
    var i = function () {
        if ($.fn.select2) {
            $.extend(true, $.fn.select2.defaults, {width: "resolve"});
    ...
    var k = function () {
        if ($.fn.fileInput) {
            $.extend(true, $.fn.fileInput.defaults, {placeholder: "No file selected...", buttontext: "Browse..."});
    ...
    var h = function () {
        if ($.fn.wysihtml5) {
            $.extend(true, $.fn.wysihtml5.defaultOptions, {stylesheets: ["./assets/css/plugins/bootstrap-wysihtml5.css"]});
