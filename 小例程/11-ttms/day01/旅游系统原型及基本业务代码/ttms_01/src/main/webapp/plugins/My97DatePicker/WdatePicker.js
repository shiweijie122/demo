...
$(function () {
    //日期
    $(".wdate-picker").click(WdatePicker);
    //$(document).on("click", ".wdate-picker", WdatePicker);

    //日期加时间
    $(".wdate-picker-time").click(function () {
        WdatePicker({ readOnly: true, dateFmt: 'yyyy-MM-dd HH:mm' })
    })
    //时间
    $(".wdate-time").click(function () {
        WdatePicker({ readOnly: true, dateFmt: 'HH:mm:ss' })
    })
})